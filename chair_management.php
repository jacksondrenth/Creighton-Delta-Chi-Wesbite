...
// query to obtain brother names
$stmt = $conn->query("SELECT brother_id, CONCAT(first_name, ' ', last_name) as name
FROM brother
...
// call the function to get the drag drop lists
// $dragDrop = getDragDropLists($conn);
$dragDrop = "";
		...
		<div class="inner">
		  <header class="major">
			...
			<div>
			  ...
			  <p><b>This serves as a way to easily change who is what chair position.</b></p>
			  <div id='message'></div>
			</div>


			<select id="drag-drop-id">
			  <option><?php echo $brothers; ?></option>
			</select>
			<div id="drag-drop"><?php echo $dragDrop; ?></div>
			
			<button onclick="dragDropUpdate();">Update</button>
